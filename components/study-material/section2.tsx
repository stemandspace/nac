...
import { Play } from "lucide-react";
    ...
    return (
        ...
        <div className="max-w-6xl mx-auto text-center mb-10">
            ...
            Already a Member of Spacetopia <br />
            (Formerly Cosmic Kids Club)?
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
            If you already have premium membership or credits in your account, you
            can instantly access NAC study material without extra payment.
            </p>
        </div>
